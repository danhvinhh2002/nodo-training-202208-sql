...
-- Chương 9 Tạo Index trên cột PROJID cho bảng ASSIGNMENT.
-- Câu1: Tạo Index trên cột PROJID cho bảng ASSIGNMENT.
CREATE INDEX PROJID ON ASSIGNMENTS_VINH(PROJID)
--Hiển thị danh sách của nhân viên thuộc sự quản lý của người có tên là 1 biến được
--     nhập từ bàn phím
